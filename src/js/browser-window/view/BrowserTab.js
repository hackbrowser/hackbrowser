...
function BrowserTab(hackBrowserWindow, tabViewId, title) {
	...
	/* ====================================
	 ...
	 ====================================== */
	let tabEl
	let tabFaviconWrapperEl
	let tabFaviconEl
	let tabLoadingSpinnerEl
	let tabCloseBtnEl
	let tabInnerTemplate
	...
	let init = function() {
		...
		let tabTitle = title ? title : "New Tab"
	...
	let handleDragStart = function(e) {
		...
		let tabStyle = window.getComputedStyle(e.target, null)
		let leftPosition = parseInt(tabStyle.getPropertyValue("left"), 10)

		let dragTransparentImage = document.createElement("img")
