...
function AddressBar(hackBrowserWindow) {
	...
	let addressBarEl
	let hasFocus
	let currentURL 		// Used to restore the current URL in case user types some value to the address bar but doesn't navigate
	 ...
	 * @param e
	 */
	let handleAddressBarClick = function (e) {
		e.preventDefault()
	}
	 ...
	 * @param e
	 */
	let handleAddressBarKeyUp = function (e) {
		// update url value
		let urlValue = addressBarEl.value
	 ...
	 */
	let handleAddressBarFocus = function () {
	 ...
	 */
	let handleAddressBarFocusOut = function () {
		hasFocus = false
